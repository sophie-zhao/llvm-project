...
; RUN: llc --mtriple=loongarch64 -mattr=+d < %s | FileCheck --check-prefix=NOSCHED %s
...
; NOSCHED-LABEL: sum:
; NOSCHED:       # %bb.0:
; NOSCHED-NEXT:    ori $a2, $zero, 1
; NOSCHED-NEXT:    blt $a1, $a2, .LBB0_4
; NOSCHED-NEXT:  # %bb.1:
; NOSCHED-NEXT:    move $a2, $zero
; NOSCHED-NEXT:    bstrpick.d $a1, $a1, 31, 0
; NOSCHED-NEXT:    .p2align 4, , 16
; NOSCHED-NEXT:  .LBB0_2: # =>This Inner Loop Header: Depth=1
; NOSCHED-NEXT:    ld.w $a3, $a0, 0
; NOSCHED-NEXT:    add.w $a2, $a3, $a2
; NOSCHED-NEXT:    addi.d $a1, $a1, -1
; NOSCHED-NEXT:    addi.d $a0, $a0, 4
; NOSCHED-NEXT:    bnez $a1, .LBB0_2
; NOSCHED-NEXT:  # %bb.3:
; NOSCHED-NEXT:    move $a0, $a2
; NOSCHED-NEXT:    ret
; NOSCHED-NEXT:  .LBB0_4:
; NOSCHED-NEXT:    move $a2, $zero
; NOSCHED-NEXT:    move $a0, $a2
